                            ...
                            <template v-slot:default>
                                <tbody>
                                    <tr v-for="(item, index) in thongTin" :key="index" :class="{'td-highlight': index%2 === 0}">
                                        <td><strong>{{item.lable}}</strong></td>
                                        <td v-if="item.value !== 'action'"><span>{{ congDanDetail[item.value]}}</span></td>
                                        <td v-else>    
                                            <v-btn                            
                                                dark
                                                text
                ...
                <v-col cols="12" md="4">
                    <v-card class="pt-4">
                        <div class="d-flex align-center flex-column">
                            <img class="mb-4" style="width: 174px; height: 174px;" src="/images/avt.png" alt="">
...
export default {
    ...
    methods: {
        ...
        editCongDan(id) {
            this.$router.push({ name: 'ChinhSuaCongDan'})
        }
    }
}
</script>
